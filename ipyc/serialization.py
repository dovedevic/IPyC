...
def add_custom_serialization(class_object: object, class_serializer):
    ...
    .. warning::
        If a custom serializer is defined, ensure a deserializer is defined as well. These methods
        could be @classmethod methods defined in the class for which you wish to transfer.
    """
...
def add_custom_deserialization(class_object: object, class_deserializer):
    ...
    .. warning::
        If a custom deserializer is defined, ensure a serializer is defined as well, or that
        the deserializer can evaluate builtin serializations. These methods could be
        @classmethod methods defined in the class for which you wish to transfer.
    """
